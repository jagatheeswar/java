...
class Minimum
{
	static int findMin(int arr[], int low, int high)
	{
		...
		if (high < low) 
        {
            System.out.println("?????????????????????????????????? low : " + low + " high: " + high + " how high value became -1?");
        return arr[0];
        }
	...
	public static void main (String[] args)
	{
        ...
        int arr19[] = {23, 5, 4, 12, 2,0,55,22,24,3};
		int n19 = arr9.length;
		System.out.println("The minimum element is "+ findMin(arr19, 0, n19-1));
    }
}
